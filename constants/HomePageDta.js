const newData=[
    { 
        ...
        rating:4.2,
        specifications:['Electric kettle with wire','1 pc of Kettle, Warranty Card','230V, 50 Hz'],
        brand:'Pigeon'
    ...
    { 
        ...
        rating:4.2,
        specifications:['Non-stick sandwich toaster','1 pc of toaster, Warranty Card','easy to use and very handy'],
        brand:'Flipkart'
    },
    { 
        id: 'product3',
        ...
        tagline: 'Deal of the Day' ,
        rating:4.4,
        specifications:['Tone your back muscles','improve blood circulation','1 pc of toaster, Warranty Card'],
        brand:'AJRO'
    },
    { 
        id: 'product4',
        ...
        tagline: 'Best Seller' ,
        rating:4.6,
        specifications:['beautiful large display','1.7-inch display with 2.5D curved edges','1 pc of smartwatch, Warranty Card'],
        brand:'Molife'
    },
    { 
        id: 'product5',
        ...
        rating:4.6,
        specifications:['Multicolor Hair Dryer','1 pc of Dryer, Warranty Card','1800 W'],
        brand:'Nova'
    },
    { 
        id: 'product6',
        ...
        tagline: 'Top Selling' ,
        rating:4.6,
        specifications:['Portable 300 mm','1 pc of Fans, Warranty Card','compact 6" size'],
        brand:'Nova'
    },
    { 
        id: 'product7',
        ...
        tagline: 'Grab Now!' ,
        rating:4.6,
        specifications:['Version 5.0 Bluetooth Headset','1 pc of Rockerz, Warranty Card','235v2 Fast Charging'],
        brand:'boAt'
    }
]
